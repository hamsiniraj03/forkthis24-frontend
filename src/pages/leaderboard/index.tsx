    ...
    return (
      <div className="relative min-h-screen flex flex-col justify-between">
        ...
        <div className="relative ml-[13rem] mr-[3rem] mt-[24.5rem]">
          ...
          <div className="absolute -top-[15.5rem] left-[9rem] transform -translate-x-1/2 text-black text-center font-jersey">
            <div className="text-[34px] font-bold">Your score: 230</div>
            <div className="text-[34px] font-bold mt-0">Your rank: 13</div>
          </div>
        ...
        <div className="absolute top-0 left-0 right-0 mx-auto z-0 w-full h-[248px] mt-[30rem] brick-col"></div>

        {/* New content below the leaderboard text */}
        <div className="relative z-20 -top-[2rem] w-full max-w-[53%] h-[550px] bg-[rgba(28,32,35,1)] mt-[-10rem] ml-auto mr-[4.5rem] rounded-[20px] p-[20px] border-[4px] border-white flex flex-col justify-start">
          {/* Row of 3 divs */}
          <div className="flex justify-around items-center mb-[10px]">
            {["Rank", "Team Name", "Score"].map((header, index) => (
              <div
                key={index}
                className="w-[250px] h-[80px] bg-[rgba(73,75,86,1)] rounded-[15px] flex justify-center items-center text-white font-['Roboto_Mono'] text-[30px] border-[3px] border-black"
              >
                {header}
              </div>
            ))}
          ...
          <div className="flex flex-col gap-[15px] overflow-hidden">
            {[
              ...
              return (
                <div
                  key={index}
                  className={`w-full max-w-[755px] h-[55px] ${
                    index === 3
                      ? "bg-[rgba(21,184,121,1)]"
                      : "bg-[rgba(77,72,72,1)]"
                  } rounded-[15px] flex justify-around items-center text-white font-['Roboto_Mono'] text-[25px]`}
                >
